...
- **Lifeform** — Your durable digital identity within the system: the persistent "you" that the Minds know across time and sessions.
...
- **Resonance** — An Illumination that changes how you actually act. Resonances are the system's real measure of success. The goal is transformation, not productivity.
