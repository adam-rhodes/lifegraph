...
- **Lifeform** — The persistent profile the system keeps for you: the canonical facts, preferences, and history every Mind reads from, so context carries across time and sessions. In practice a profile plus its links into the graph, not a separate AI persona.
